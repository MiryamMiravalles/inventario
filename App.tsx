  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col">
      ...
      <nav className="bg-slate-900/80 backdrop-blur-sm shadow-lg sticky top-0 z-30 border-b border-slate-800">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                type="button"
                className="bg-slate-800 inline-flex items-center justify-center p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 focus:ring-white"
        ...
        {/* 🛑 MENÚ DESPLEGABLE MÓVIL (VISIBLE SOLO EN PANTALLAS PEQUEÑAS) */}
        {isMenuOpen && (
